...
############################
#Data Security Workshop - Workshop POE Report
#Author: Jim Banach
...
$searchoutput = foreach($s in $search){Get-ComplianceSearch $s.name | Select-Object Name,ContentMatchQuery,CreatedTime,LastModifiedTime,JobStartTime,CreatedBy,Status,*Location}
